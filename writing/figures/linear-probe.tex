...
\node[phase] at (11.0, 2.6) {Evaluation};

% s_t input
\node[lbl] at (9.4, 0) {$s_t$};
\draw[arr, black!30] (9.7, 0) -- (10.1, 0);

% Compact encoder trapezoid
\fill[encfade, draw=black!25, thick, line join=round]
    (10.1, -0.9) -- (10.1, 0.9) -- (12.0, 0.45) -- (12.0, -0.45) -- cycle;
\node[font=\scriptsize, text=black!45] at (10.95, 0) {$f_\theta$};

\node[lbl, text=black!35] at (11.0, -1.2) {weights fixed};

% h_t output
\draw[arr] (12.0, 0) -- (12.7, 0);
\node[draw=black!40, thick, fill=outfront, rounded corners=2pt,
      font=\small, inner sep=5pt] (ht) at (13.1, 0) {$h_t$};
