...
\draw[arr] (probe.east) -- ++(0.3,0) |- (8.6, 0.6);
\draw[arr] (probe.east) -- ++(0.3,0) |- (8.6, -0.6);

\node[box, fill=predorange] (pred) at (9.2, 0.6) {$\hat{y}$};
\node[box, fill=gtgreen] (gt) at (9.2, -0.6) {$y$};

% Loss
\node[box, fill=black!8, font=\small] (loss) at (10.9, 0)
    {$\mathcal{L}$};
\draw[arr] (pred) -- (loss);
\draw[arr] (gt) -- (loss);
