...
Use this directory to capture structured notes for each paper that informs the thesis experiments.

Recommended format per file:

- Bibliographic header (title, authors, venue, year).
- Key contributions and takeaways for this project.
