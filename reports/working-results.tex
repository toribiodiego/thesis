...
\bottomrule
\end{tabular}
\caption{Invalid ``Rainbow'' results. These runs used vanilla DQN with
Rainbow hyperparameters (Adam at lower lr, 20K warmup) but no actual
Rainbow components. The modest differences from DQN Baseline are
consistent with optimizer and hyperparameter changes alone.}
