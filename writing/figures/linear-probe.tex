...
% Linear probe
\draw[arr] (repr) -- (5.2, 0);
\node[box, fill=black!10, minimum width=1.6cm] (probe)
    at (6.3, 0) {Linear probe};
\node[lbl, text=black!30] at (6.3, -0.75) {trainable};

% Prediction
\draw[arr] (probe) -- (8.0, 0);
\node[box, fill=black!8] (loss) at (9.2, 0)
    {$\mathcal{L}(\hat{y}, y)$};
