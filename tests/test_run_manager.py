...
def test_create_run_dir_with_seed(tmp_path):
    ...
    run_dir = create_run_dir(str(base_dir), "pong", seed=42, timestamp="20250113_120000")
...
def test_create_run_dir_without_seed(tmp_path):
    ...
    base_dir = tmp_path / "runs"
    run_dir = create_run_dir(str(base_dir), "pong", seed=None, timestamp="20250113_120000")
